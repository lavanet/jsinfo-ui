...
export const chainDictionary: { [key: string]: ChainInfo } = {
    ...
    bsc: { name: "BNB Chain", icon: "/icons/binance-smart-chain.svg" },
    bsct: { name: "BNB Chain Testnet", icon: "/icons/binance-smart-chain.svg" },
    ...
    celo: { name: "Celo", icon: "/icons/celo_icon.png" },
    alfajores: { name: "Celo Alfajores Testnet", icon: "/icons/celo_icon.png" },
