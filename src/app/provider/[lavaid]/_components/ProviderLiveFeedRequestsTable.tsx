// src/app/provider/[lavaid]/_components/ProviderLiveFeedRequestsTable.tsx
...
const ProviderLiveFeedRequestsTable: React.FC<{ data: Entry[] }> = ({ data }) => {
    return (
        <>
...
export default ProviderLiveFeedRequestsTable;